...
createMarker(map, 30.2766666667, -103.596111111, 'Terrence Ross', 'red');
createMarker(map, 48, 8.91805555556, 'Robin Hegenbarth', 'red');
createMarker(map, 45.9886111111, 14.4052777778, 'Mitja Govedi?', 'red');
...
createMarker(map, 34.8441666667, 33.5783333333, 'Iris Charalambidou', 'red');
...
createMarker(map, 45.6072222222, 14.0480555556, 'Mitja Govedi?', 'red');
createMarker(map, 34.8441666667, 33.5783333333, 'Christodoulos Antoniou', 'red');
	}