			...
			var observers = [];
			observers.push( createObserverMarker(-155.45583333333,19.759444444444 , new GInfoWindowTab('Observer', 'Observer: SIMONA VADUVESCU<br/>Site: Hale Pohaku, Mauna Kea, Hawaii'), 'red') );
...
observers.push( createObserverMarker(-113,53.541111111111 , new GInfoWindowTab('Observer', 'Observer: BRUCE MCCURDY<br/>Site: Strathcona Wilderness Centre'), 'red') );
...
observers.push( createObserverMarker(-78.965277777778,42.963888888889 , new GInfoWindowTab('Observer', 'Observer: WILLIAM WATSON<br/>Site: Grand Island, New York'), 'red') );
...
observers.push( createObserverMarker(6.9644444444444,52.414166666667 , new GInfoWindowTab('Observer', 'Observer: SIETSE DIJKSTRA<br/>Site: Cosmos sterrenwacht Lattrop'), 'red') );
...
observers.push( createObserverMarker(7.1166666666667,52.416666666667 , new GInfoWindowTab('Observer', 'Observer: SIETSE DIJKSTRA<br/>Site: Gronau'), 'red') );
